<div id="navWrap">
	<nav>
		<ul>
			<li><?php echo anchor('/dashboard', 'Home', 'title = "Heatseek Overview"') ?></li>
			<li><?php echo anchor('/home/viewProfile', 'Profile', 'title = "View & Edit Your Profile"') ?></li>
			<li><?php echo anchor('', 'Planner', 'title = "Monthly, Daily and Hourly Planner"') ?></li>
			<li><?php echo anchor('/dashboard', 'Dashboard', 'title = "Account Settings"') ?></li>
		</ul>
		<br class="clearFix" />
	</nav>
	<div id="navPulldown">
